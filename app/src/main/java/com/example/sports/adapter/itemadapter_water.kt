...
import com.example.sports.ui.home.water_viewmodel
import com.example.sports.ui.slideshow.air_detail

class itemadapter_water (
    private val context: Context,
    private val dataset: List<sports>
): RecyclerView.Adapter<itemadapter_water.WaterViewHolder>() {
    private val viewModel = water_viewmodel()

    class WaterViewHolder(val view: View) : RecyclerView.ViewHolder(view){
        val imageView: ImageView = view.findViewById(R.id.item_image3)
        val nameText: TextView = view.findViewById(R.id.item_title3)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): WaterViewHolder {
        ...
        return WaterViewHolder(adapterLayout)
    }
